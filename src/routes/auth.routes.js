...
const { login, registrarUsuario, getUsuario, putPassword, putEstatus, deleteUsuario } = require('../controllers/auth.controller');
...
router.put('/put/estatus/:nombre_usuario', verificarToken, authorizeRole(["gestionar_usuarios"]), putEstatus);
